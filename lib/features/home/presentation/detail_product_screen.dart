      ...
      child: Scaffold(
        ...
        body: BlocBuilder<DetailProductCubit, DetailProductState>(
          builder: (context, state) {
            ...
            } else if (DetailProductCubit.get(context).detailProductModel != null) {
                      ...
                      Row(
                        ...
                        children: [
                          GestureDetector(
                            ...
                            child: CircleAvatar(
                              radius: 20,
                              backgroundColor: DetailProductCubit.get(context).colorG,
                              child: CircleAvatar(
                                radius: 15,
                          ...
                          GestureDetector(
                            ...
                            child: CircleAvatar(
                              radius: 20,
                              backgroundColor: DetailProductCubit.get(context).colorL,
                              child: CircleAvatar(
                                radius: 15,
                          ...
                          GestureDetector(
                            ...
                            child: CircleAvatar(
                              radius: 20,
                              backgroundColor: DetailProductCubit.get(context).colorB,
                              child: CircleAvatar(
                                radius: 15,
                          ...
                          child: Row(
                            children: [
                              GestureDetector(
                                onTap: () {
                                  try{
                                   var data= DetailProductCubit.get(context).detailProductModel;
                                   SQLHelper.add(data!.id.toString(), data.title!, data.image!, data.rating!.count!, data.price!);
                                    Navigator.push(context, MaterialPageRoute(builder: (context) {
                                      return CartScreen();
                                    },));
                                  } catch (e) {
                                    print("_______________${e.toString()}___________________________");
